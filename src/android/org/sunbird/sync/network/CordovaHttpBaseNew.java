...
public class CordovaHttpBaseNew {
  ...
  public CordovaHttpBaseNew(String method, String url, String serializer, Object data, JSONObject headers, int timeout,
  ...
  public CordovaHttpBaseNew(String method, String url, JSONObject headers, int timeout, boolean followRedirects,
                            String responseType, TLSConfiguration tlsConfiguration) {
  ...
  protected void processResponse(HttpRequest request, HttpResponse response) throws Exception {
